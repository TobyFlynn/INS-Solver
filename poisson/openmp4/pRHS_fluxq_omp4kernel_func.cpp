...
void pRHS_fluxq_omp4_kernel(
  ...
  for ( int n_op=0; n_op<count; n_op++ ){
    ...
    const double *tau = &data2[15*n_op];
    const double *du = &data3[15*n_op];
    const double *qx = &data4[15*n_op];
    const double *qy = &data5[15*n_op];
    double *exQx = &data6[15*n_op];
    double *exQy = &data7[15*n_op];
    double *fluxq = &data8[15*n_op];
