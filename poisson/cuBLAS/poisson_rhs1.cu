...
void poisson_rhs_blas1(INSData *nsData) {
  ...
  cublas_poisson_rhs1(handle, nsData->numCells, (double *)nsData->pFluxXu->data_d,
                   (double *)nsData->pFluxYu->data_d, (double *)nsData->pDuDx->data_d,
                   (double *)nsData->pDuDy->data_d);
