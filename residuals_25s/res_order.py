...
for res in residuals:
    if first_row:
        ...
        h_logs_2 = [h_logs[1], h_logs[2], h_logs[3]]
        res_logs_2 = [math.log(res[1]), math.log(res[2]), math.log(res[3])]
        fit_2 = stats.linregress(h_logs_2, res_logs_2)
        orders.append([times[i], fit_2.slope])
    i = i + 1
...
# h_logs = [math.log(1.0), math.log(0.5), math.log(0.25)]
# res_logs = [math.log(9.10e-4), math.log(1.09e-4), math.log(1.03e-5)]
# fit = stats.linregress(h_logs, res_logs)
# print(fit.slope)
