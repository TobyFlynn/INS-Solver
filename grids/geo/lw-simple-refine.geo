...
Point(15) = {inlet_size, inlet_radius, 0.0, inlet_size};
Point(16) = {inlet_size, 0.0, inlet_radius, inlet_size};
Point(17) = {inlet_size, -inlet_radius, 0.0, inlet_size};
Point(18) = {inlet_size, 0.0, -inlet_radius, inlet_size};

Point(19) = {pipe_length / 8.0, inlet_radius, 0.0, inlet_size};
Point(20) = {pipe_length / 8.0, 0.0, inlet_radius, inlet_size};
Point(21) = {pipe_length / 8.0, -inlet_radius, 0.0, inlet_size};
Point(22) = {pipe_length / 8.0, 0.0, -inlet_radius, inlet_size};

Line(17) = {15, 19};
Line(18) = {16, 20};
Line(19) = {17, 21};
Line(20) = {18, 22};
Line{17,18,19,20} In Volume{1};
