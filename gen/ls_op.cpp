...
void LS::advec_step(op_dat input, op_dat output) {
  ...
  op_par_loop_ls_advec_edges("ls_advec_edges",mesh->edges,
              ...
              op_arg_dat(exAdvec,-2,mesh->edge2cells,12,"double",OP_INC));
  ...
  op_par_loop_ls_advec_bedges("ls_advec_bedges",mesh->bedges,
              ...
              op_arg_dat(exAdvec,0,mesh->bedge2cells,12,"double",OP_INC));
  ...
  op_par_loop_ls_advec_rhs("ls_advec_rhs",mesh->cells,
              ...
              op_arg_dat(input,-1,OP_ID,10,"double",OP_READ),
              op_arg_dat(exAdvec,-1,OP_ID,12,"double",OP_RW),
              op_arg_dat(u,-1,OP_ID,10,"double",OP_READ),
              op_arg_dat(v,-1,OP_ID,10,"double",OP_READ),
              op_arg_dat(mesh->fscale,-1,OP_ID,12,"double",OP_READ),
              op_arg_dat(mesh->nx,-1,OP_ID,12,"double",OP_READ),
              op_arg_dat(mesh->ny,-1,OP_ID,12,"double",OP_READ),
