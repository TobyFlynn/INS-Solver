...
void Solver::advection(int currentInd, double a0, double a1, double b0,
  ...
  op_par_loop(advection_faces, "advection_faces", mesh->edges,
              ...
              op_arg_dat(data->exQ[0], -2, mesh->edge2cells, 3 * 5, "double", OP_INC),
              op_arg_dat(data->exQ[1], -2, mesh->edge2cells, 3 * 5, "double", OP_INC));
  ...
  op_par_loop(advection_bc, "advection_bc", mesh->bedges,
              ...
              op_arg_dat(data->exQ[0], 0, mesh->bedge2cells, 3 * 5, "double", OP_INC),
              op_arg_dat(data->exQ[1], 0, mesh->bedge2cells, 3 * 5, "double", OP_INC));
  ...
  op_par_loop(advection_numerical_flux, "advection_numerical_flux", mesh->cells,
              ...
              op_arg_dat(data->Q[currentInd][0], -1, OP_ID, 15, "double", OP_READ),
              op_arg_dat(data->Q[currentInd][1], -1, OP_ID, 15, "double", OP_READ),
              op_arg_dat(data->exQ[0],  -1, OP_ID, 3 * 5, "double", OP_RW),
              op_arg_dat(data->exQ[1],  -1, OP_ID, 3 * 5, "double", OP_RW),
              op_arg_dat(data->flux[0], -1, OP_ID, 3 * 5, "double", OP_WRITE),
              op_arg_dat(data->flux[1], -1, OP_ID, 3 * 5, "double", OP_WRITE));

  op2_gemv(true, 15, 3 * 5, 1.0, constants->get_ptr(DGConstants::LIFT), 3 * 5, data->flux[0], 1.0, data->N[currentInd][0]);
  op2_gemv(true, 15, 3 * 5, 1.0, constants->get_ptr(DGConstants::LIFT), 3 * 5, data->flux[1], 1.0, data->N[currentInd][1]);
...
bool Solver::pressure(int currentInd, double a0, double a1, double b0,
  ...
  op_par_loop(pressure_bc, "pressure_bc", mesh->bedges,
              ...
              op_arg_dat(mesh->x,   0, mesh->bedge2cells, 15, "double", OP_READ),
              op_arg_dat(mesh->y,   0, mesh->bedge2cells, 15, "double", OP_READ),
              op_arg_dat(mesh->nx,  0, mesh->bedge2cells, 3 * 5, "double", OP_READ),
              op_arg_dat(mesh->ny,  0, mesh->bedge2cells, 3 * 5, "double", OP_READ),
              op_arg_dat(data->nu,  0, mesh->bedge2cells, 15, "double", OP_READ),
              ...
              op_arg_dat(data->dPdN[currentInd], 0, mesh->bedge2cells, 3 * 5, "double", OP_INC));
  ...
  op_par_loop(pressure_rhs, "pressure_rhs", mesh->cells,
              ...
              op_arg_dat(mesh->sJ, -1, OP_ID, 3 * 5, "double", OP_READ),
              op_arg_dat(data->dPdN[currentInd], -1, OP_ID, 3 * 5, "double", OP_READ),
              op_arg_dat(data->dPdN[(currentInd + 1) % 2], -1, OP_ID, 3 * 5, "double", OP_RW),
              op_arg_dat(data->divVelT, -1, OP_ID, 15, "double", OP_RW));

  op2_gemv(true, 15, 3 * 5, 1.0, constants->get_ptr(DGConstants::LIFT), 3 * 5, data->dPdN[(currentInd + 1) % 2], 1.0, data->divVelT);
  ...
  op_par_loop(pressure_grad_flux, "pressure_grad_flux", mesh->edges,
              op_arg_dat(mesh->edgeNum, -1, OP_ID, 2, "int", OP_READ),
              op_arg_dat(mesh->reverse, -1, OP_ID, 1, "bool", OP_READ),
              op_arg_dat(mesh->nx,     -2, mesh->edge2cells, 3 * 5, "double", OP_READ),
              op_arg_dat(mesh->ny,     -2, mesh->edge2cells, 3 * 5, "double", OP_READ),
              op_arg_dat(mesh->fscale, -2, mesh->edge2cells, 3 * 5, "double", OP_READ),
              op_arg_dat(data->p,      -2, mesh->edge2cells, 15, "double", OP_READ),
              op_arg_dat(data->pFluxX, -2, mesh->edge2cells, 3 * 5, "double", OP_INC),
              op_arg_dat(data->pFluxY, -2, mesh->edge2cells, 3 * 5, "double", OP_INC));

  op2_gemv(true, 15, 3 * 5, -1.0, constants->get_ptr(DGConstants::LIFT), 3 * 5, data->pFluxX, 1.0, data->dpdx);
  op2_gemv(true, 15, 3 * 5, -1.0, constants->get_ptr(DGConstants::LIFT), 3 * 5, data->pFluxY, 1.0, data->dpdy);
  ...
  op_par_loop(pressure_update_vel, "pressure_update_vel", mesh->cells,
              ...
              op_arg_dat(data->dPdN[(currentInd + 1) % 2], -1, OP_ID, 3 * 5, "double", OP_WRITE),
              op_arg_dat(data->prBC,   -1, OP_ID, 21, "double", OP_WRITE),
              op_arg_dat(data->pFluxX, -1, OP_ID, 3 * 5, "double", OP_WRITE),
              op_arg_dat(data->pFluxY, -1, OP_ID, 3 * 5, "double", OP_WRITE),);
