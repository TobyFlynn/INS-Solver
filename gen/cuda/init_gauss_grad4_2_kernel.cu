...
//user function
__device__ void init_gauss_grad4_2_gpu( const int *bedgeNum,
...
__global__ void op_cuda_init_gauss_grad4_2(
  ...
  if (tid + start < end) {
    ...
    init_gauss_grad4_2_gpu(arg0+n*1,
                       ind_arg0+map1idx*18,
                       ind_arg1+map1idx*18,
                       ind_arg2+map1idx*60,
                       ind_arg3+map1idx*60,
  ...
  if (set_size > 0) {
    ...
    for ( int round=0; round<2; round++ ){
      ...
      if (end-start>0) {
        ...
        op_cuda_init_gauss_grad4_2<<<nblocks,nthread>>>(
        (double *)arg1.data_d,
        (double *)arg2.data_d,
        (double *)arg3.data_d,
        (double *)arg4.data_d,
