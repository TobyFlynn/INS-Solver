...
__global__ void op_cuda_ls_flux(
  ...
  if (tid + start < end) {
    ...
    atomicAdd(&ind_arg6[0+map3idx*9],arg15_l[0]);
    atomicAdd(&ind_arg6[1+map3idx*9],arg15_l[1]);
    atomicAdd(&ind_arg6[2+map3idx*9],arg15_l[2]);
    atomicAdd(&ind_arg6[3+map3idx*9],arg15_l[3]);
    atomicAdd(&ind_arg6[4+map3idx*9],arg15_l[4]);
    atomicAdd(&ind_arg6[5+map3idx*9],arg15_l[5]);
    atomicAdd(&ind_arg6[6+map3idx*9],arg15_l[6]);
    atomicAdd(&ind_arg6[7+map3idx*9],arg15_l[7]);
    atomicAdd(&ind_arg6[8+map3idx*9],arg15_l[8]);
    ...
    atomicAdd(&ind_arg7[0+map3idx*9],arg17_l[0]);
    atomicAdd(&ind_arg7[1+map3idx*9],arg17_l[1]);
    atomicAdd(&ind_arg7[2+map3idx*9],arg17_l[2]);
    atomicAdd(&ind_arg7[3+map3idx*9],arg17_l[3]);
    atomicAdd(&ind_arg7[4+map3idx*9],arg17_l[4]);
    atomicAdd(&ind_arg7[5+map3idx*9],arg17_l[5]);
    atomicAdd(&ind_arg7[6+map3idx*9],arg17_l[6]);
    atomicAdd(&ind_arg7[7+map3idx*9],arg17_l[7]);
    atomicAdd(&ind_arg7[8+map3idx*9],arg17_l[8]);
  }
}
...
void op_par_loop_ls_flux(char const *name, op_set set,
  ...
  args[14] = arg14;
  for ( int v=1; v<2; v++ ){
    args[14 + v] = op_arg_dat(arg14.dat, v, arg14.map, 9, "double", OP_INC);
  }

  arg16.idx = 0;
  args[16] = arg16;
  for ( int v=1; v<2; v++ ){
    args[16 + v] = op_arg_dat(arg16.dat, v, arg16.map, 9, "double", OP_INC);
  }
