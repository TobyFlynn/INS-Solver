...
__global__ void op_cuda_ls_advec_edges(
  ...
  if (tid + start < end) {
    ...
    ls_advec_edges_gpu(arg0+n*2,
                   ...
                   arg2_vec,
                   arg4_vec);
    atomicAdd(&ind_arg1[0+map2idx*6],arg4_l[0]);
    atomicAdd(&ind_arg1[1+map2idx*6],arg4_l[1]);
    atomicAdd(&ind_arg1[2+map2idx*6],arg4_l[2]);
    atomicAdd(&ind_arg1[3+map2idx*6],arg4_l[3]);
    atomicAdd(&ind_arg1[4+map2idx*6],arg4_l[4]);
    atomicAdd(&ind_arg1[5+map2idx*6],arg4_l[5]);
