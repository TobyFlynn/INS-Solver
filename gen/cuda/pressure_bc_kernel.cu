...
__global__ void op_cuda_pressure_bc(
  ...
  if (tid + start < end) {
    ...
    pressure_bc_gpu(arg0+n*1,
                ...
                ind_arg9+map4idx*6,
                arg14_l);
    atomicAdd(&ind_arg10[0+map4idx*9],arg14_l[0]);
    atomicAdd(&ind_arg10[1+map4idx*9],arg14_l[1]);
    atomicAdd(&ind_arg10[2+map4idx*9],arg14_l[2]);
    atomicAdd(&ind_arg10[3+map4idx*9],arg14_l[3]);
    atomicAdd(&ind_arg10[4+map4idx*9],arg14_l[4]);
    atomicAdd(&ind_arg10[5+map4idx*9],arg14_l[5]);
    atomicAdd(&ind_arg10[6+map4idx*9],arg14_l[6]);
    atomicAdd(&ind_arg10[7+map4idx*9],arg14_l[7]);
    atomicAdd(&ind_arg10[8+map4idx*9],arg14_l[8]);
  }
}
