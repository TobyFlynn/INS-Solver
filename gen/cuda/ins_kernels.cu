...
__constant__ int FMASK_cuda[9];
__constant__ double ic_u_cuda;
__constant__ double ic_v_cuda;
__constant__ double cubW_g_cuda[16];
__constant__ double cubV_g_cuda[96];
__constant__ double cubVDr_g_cuda[96];
__constant__ double cubVDs_g_cuda[96];
__constant__ double gF0Dr_g_cuda[24];
__constant__ double gF0Ds_g_cuda[24];
__constant__ double gF1Dr_g_cuda[24];
__constant__ double gF1Ds_g_cuda[24];
__constant__ double gF2Dr_g_cuda[24];
__constant__ double gF2Ds_g_cuda[24];
__constant__ double gaussW_g_cuda[4];
__constant__ double gFInterp0_g_cuda[24];
__constant__ double gFInterp1_g_cuda[24];
__constant__ double gFInterp2_g_cuda[24];
__constant__ double gF0DrR_g_cuda[24];
__constant__ double gF0DsR_g_cuda[24];
__constant__ double gF1DrR_g_cuda[24];
__constant__ double gF1DsR_g_cuda[24];
__constant__ double gF2DrR_g_cuda[24];
__constant__ double gF2DsR_g_cuda[24];
__constant__ double gFInterp0R_g_cuda[24];
__constant__ double gFInterp1R_g_cuda[24];
__constant__ double gFInterp2R_g_cuda[24];
