...
__global__ void op_cuda_ls_bflux(
  ...
  if (tid + start < end) {
    ...
    atomicAdd(&ind_arg7[0+map1idx*18],arg8_l[0]);
    atomicAdd(&ind_arg7[1+map1idx*18],arg8_l[1]);
    atomicAdd(&ind_arg7[2+map1idx*18],arg8_l[2]);
    atomicAdd(&ind_arg7[3+map1idx*18],arg8_l[3]);
    atomicAdd(&ind_arg7[4+map1idx*18],arg8_l[4]);
    atomicAdd(&ind_arg7[5+map1idx*18],arg8_l[5]);
    atomicAdd(&ind_arg7[6+map1idx*18],arg8_l[6]);
    atomicAdd(&ind_arg7[7+map1idx*18],arg8_l[7]);
    atomicAdd(&ind_arg7[8+map1idx*18],arg8_l[8]);
    atomicAdd(&ind_arg7[9+map1idx*18],arg8_l[9]);
    atomicAdd(&ind_arg7[10+map1idx*18],arg8_l[10]);
    atomicAdd(&ind_arg7[11+map1idx*18],arg8_l[11]);
    atomicAdd(&ind_arg7[12+map1idx*18],arg8_l[12]);
    atomicAdd(&ind_arg7[13+map1idx*18],arg8_l[13]);
    atomicAdd(&ind_arg7[14+map1idx*18],arg8_l[14]);
    atomicAdd(&ind_arg7[15+map1idx*18],arg8_l[15]);
    atomicAdd(&ind_arg7[16+map1idx*18],arg8_l[16]);
    atomicAdd(&ind_arg7[17+map1idx*18],arg8_l[17]);
  }
}
