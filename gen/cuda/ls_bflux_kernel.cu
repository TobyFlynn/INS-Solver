...
__global__ void op_cuda_ls_bflux(
  ...
  if (tid + start < end) {
    ...
    atomicAdd(&ind_arg6[0+map1idx*9],arg7_l[0]);
    atomicAdd(&ind_arg6[1+map1idx*9],arg7_l[1]);
    atomicAdd(&ind_arg6[2+map1idx*9],arg7_l[2]);
    atomicAdd(&ind_arg6[3+map1idx*9],arg7_l[3]);
    atomicAdd(&ind_arg6[4+map1idx*9],arg7_l[4]);
    atomicAdd(&ind_arg6[5+map1idx*9],arg7_l[5]);
    atomicAdd(&ind_arg6[6+map1idx*9],arg7_l[6]);
    atomicAdd(&ind_arg6[7+map1idx*9],arg7_l[7]);
    atomicAdd(&ind_arg6[8+map1idx*9],arg7_l[8]);
    atomicAdd(&ind_arg7[0+map1idx*9],arg8_l[0]);
    atomicAdd(&ind_arg7[1+map1idx*9],arg8_l[1]);
    atomicAdd(&ind_arg7[2+map1idx*9],arg8_l[2]);
    atomicAdd(&ind_arg7[3+map1idx*9],arg8_l[3]);
    atomicAdd(&ind_arg7[4+map1idx*9],arg8_l[4]);
    atomicAdd(&ind_arg7[5+map1idx*9],arg8_l[5]);
    atomicAdd(&ind_arg7[6+map1idx*9],arg8_l[6]);
    atomicAdd(&ind_arg7[7+map1idx*9],arg8_l[7]);
    atomicAdd(&ind_arg7[8+map1idx*9],arg8_l[8]);
  }
}
