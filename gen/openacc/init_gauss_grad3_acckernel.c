...
//user function
//#pragma acc routine
inline void init_gauss_grad3_openacc( const int *edgeNum,
...
void op_par_loop_init_gauss_grad3(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      #pragma acc parallel loop independent deviceptr(col_reord,map1,data0,data17,data18,data1,data3,data5,data7,data9,data11,data13,data15)
