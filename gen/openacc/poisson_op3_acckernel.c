...
//user function
//#pragma acc routine
inline void poisson_op3_openacc( const int *edgeType, const int *edgeNum,
...
void op_par_loop_poisson_op3(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      #pragma acc parallel loop independent deviceptr(col_reord,map5,data0,data1,data5,data6,data7,data8,data9,data10,data11,data12)
