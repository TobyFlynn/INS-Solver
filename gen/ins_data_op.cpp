...
void INSData::init() {
  ...
  op_par_loop_gauss_grad_faces("gauss_grad_faces",mesh->edges,
              op_arg_dat(mesh->edgeNum,-1,OP_ID,2,"int",OP_READ),
              op_arg_dat(mDx[0],-2,mesh->edge2cells,105,"double",OP_READ),
              op_arg_dat(mDy[0],-2,mesh->edge2cells,105,"double",OP_READ),
              op_arg_dat(mDx[1],-2,mesh->edge2cells,105,"double",OP_READ),
              op_arg_dat(mDy[1],-2,mesh->edge2cells,105,"double",OP_READ),
              op_arg_dat(mDx[2],-2,mesh->edge2cells,105,"double",OP_READ),
              op_arg_dat(mDy[2],-2,mesh->edge2cells,105,"double",OP_READ),
              op_arg_dat(pDx[0],-2,mesh->edge2cells,105,"double",OP_INC),
              op_arg_dat(pDy[0],-2,mesh->edge2cells,105,"double",OP_INC),
              op_arg_dat(pDx[1],-2,mesh->edge2cells,105,"double",OP_INC),
              op_arg_dat(pDy[1],-2,mesh->edge2cells,105,"double",OP_INC),
              op_arg_dat(pDx[2],-2,mesh->edge2cells,105,"double",OP_INC),
              op_arg_dat(pDy[2],-2,mesh->edge2cells,105,"double",OP_INC));
