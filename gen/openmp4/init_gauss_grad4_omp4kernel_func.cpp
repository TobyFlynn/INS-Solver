...
void init_gauss_grad4_omp4_kernel(
  int *data0,
  int dat0size,
  int *map1,
  int map1size,
  ...
  #pragma omp target teams num_teams(num_teams) thread_limit(nthread) map(to:data0[0:dat0size],data9[0:dat9size])\
