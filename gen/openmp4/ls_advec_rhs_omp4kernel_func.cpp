...
void ls_advec_rhs_omp4_kernel(
  ...
  for ( int n_op=0; n_op<count; n_op++ ){
    //variable mapping
    const double *dFdr = &data0[15*n_op];
    const double *dFds = &data1[15*n_op];
    const double *dGdr = &data2[15*n_op];
    const double *dGds = &data3[15*n_op];
    const double *rx = &data4[15*n_op];
    const double *ry = &data5[15*n_op];
    const double *sx = &data6[15*n_op];
    const double *sy = &data7[15*n_op];
    const double *q = &data8[15*n_op];
    double *exQ = &data9[15*n_op];
    const double *u = &data10[15*n_op];
    const double *v = &data11[15*n_op];
    const double *fscale = &data12[15*n_op];
    const double *nx = &data13[15*n_op];
    const double *ny = &data14[15*n_op];
    double *nFlux = &data15[15*n_op];
    double *output = &data16[15*n_op];
