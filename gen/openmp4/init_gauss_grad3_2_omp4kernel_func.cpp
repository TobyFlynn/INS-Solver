...
void init_gauss_grad3_2_omp4_kernel(
  ...
  #pragma omp target teams num_teams(num_teams) thread_limit(nthread) map(to:data0[0:dat0size],data19[0:dat19size],data20[0:dat20size])\
    map(to:col_reord[0:set_size1],map1[0:map1size],data1[0:dat1size],data3[0:dat3size],data5[0:dat5size],data7[0:dat7size],data9[0:dat9size],data11[0:dat11size],data13[0:dat13size],data15[0:dat15size],data17[0:dat17size])
  ...
  for ( int e=start; e<end; e++ ){
    ...
    const double *factL = &data17[18 * map1idx];
    const double *factR = &data17[18 * map2idx];
    double *dL = &data19[60*n_op];
    double *dR = &data20[60*n_op];
