...
void gauss_op_omp4_kernel(
  ...
  for ( int n_op=0; n_op<count; n_op++ ){
    ...
    const double *sJ = &data1[9*n_op];
    const double *mD0 = &data2[9*n_op];
    double *f0_0 = &data3[9*n_op];
    double *f0_1 = &data4[9*n_op];
    double *f0_2 = &data5[9*n_op];
    const double *mD1 = &data6[9*n_op];
    double *f1_0 = &data7[9*n_op];
    double *f1_1 = &data8[9*n_op];
    double *f1_2 = &data9[9*n_op];
    const double *mD2 = &data10[9*n_op];
    double *f2_0 = &data11[9*n_op];
    double *f2_1 = &data12[9*n_op];
    double *f2_2 = &data13[9*n_op];
    double *pDy0 = &data14[9*n_op];
    double *pDy1 = &data15[9*n_op];
    double *pDy2 = &data16[9*n_op];
    ...
    for(int m = 0; m < 3; m++) {
      for(int n = 0; n < 3; n++) {
        int ind = m * 3 + n;
        f1_0[ind] = gaussW_g_ompkernel[n] * sJ[n + 3] * tau[1] * f1_0[ind];
        f1_1[ind] = gaussW_g_ompkernel[n] * sJ[n + 3] * f1_1[ind];
        f1_2[ind] = gaussW_g_ompkernel[n] * sJ[n + 3] * f1_2[ind];
      }
    }
    ...
    for(int m = 0; m < 3; m++) {
      for(int n = 0; n < 3; n++) {
        int ind = m * 3 + n;
        f2_0[ind] = gaussW_g_ompkernel[n] * sJ[n + 2 * 3] * tau[2] * f2_0[ind];
        f2_1[ind] = gaussW_g_ompkernel[n] * sJ[n + 2 * 3] * f2_1[ind];
        f2_2[ind] = gaussW_g_ompkernel[n] * sJ[n + 2 * 3] * f2_2[ind];
      }
    }
