...
void advection_numerical_flux_omp4_kernel(
  ...
  for ( int n_op=0; n_op<count; n_op++ ){
    //variable mapping
    const double *fscale = &data0[6*n_op];
    const double *nx = &data1[6*n_op];
    const double *ny = &data2[6*n_op];
    const double *q0 = &data3[3*n_op];
    const double *q1 = &data4[3*n_op];
    double *exQ0 = &data5[6*n_op];
    double *exQ1 = &data6[6*n_op];
    double *flux0 = &data7[6*n_op];
    double *flux1 = &data8[6*n_op];
