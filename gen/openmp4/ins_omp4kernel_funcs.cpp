...
int FMASK_ompkernel[9];
double ic_u_ompkernel;
double ic_v_ompkernel;
double cubW_g_ompkernel[16];
double cubV_g_ompkernel[96];
double cubVDr_g_ompkernel[96];
double cubVDs_g_ompkernel[96];
double gF0Dr_g_ompkernel[24];
double gF0Ds_g_ompkernel[24];
double gF1Dr_g_ompkernel[24];
double gF1Ds_g_ompkernel[24];
double gF2Dr_g_ompkernel[24];
double gF2Ds_g_ompkernel[24];
double gaussW_g_ompkernel[4];
double gFInterp0_g_ompkernel[24];
double gFInterp1_g_ompkernel[24];
double gFInterp2_g_ompkernel[24];
double gF0DrR_g_ompkernel[24];
double gF0DsR_g_ompkernel[24];
double gF1DrR_g_ompkernel[24];
double gF1DsR_g_ompkernel[24];
double gF2DrR_g_ompkernel[24];
double gF2DsR_g_ompkernel[24];
double gFInterp0R_g_ompkernel[24];
double gFInterp1R_g_ompkernel[24];
double gFInterp2R_g_ompkernel[24];
...
void op_decl_const_char(int dim, char const *type,
  ...
  #pragma omp target enter data map(to:FMASK_ompkernel[:9])
