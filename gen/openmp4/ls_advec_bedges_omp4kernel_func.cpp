...
void ls_advec_bedges_omp4_kernel(
  ...
  for ( int e=start; e<end; e++ ){
    ...
    const double *x = &data2[15 * map2idx];
    const double *y = &data3[15 * map2idx];
    const double *q = &data4[15 * map2idx];
    double *exQ = &data5[15 * map2idx];

    //inline function
    
    int exInd = *bedgeNum * 5;
    int *fmask = &FMASK_ompkernel[*bedgeNum * 5];
