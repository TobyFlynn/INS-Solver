...
void init_gauss_grad_omp4_kernel(
  ...
  for ( int n_op=0; n_op<count; n_op++ ){
    ...
    double *Dx0 = &data4[105*n_op];
    double *Dy0 = &data5[105*n_op];
    double *Dx1 = &data6[105*n_op];
    double *Dy1 = &data7[105*n_op];
    double *Dx2 = &data8[105*n_op];
    double *Dy2 = &data9[105*n_op];
    ...
    for(int m = 0; m < 7; m++) {
      for(int n = 0; n < 15; n++) {
        int ind = m * 15 + n;
        Dx2[ind] = rx[m + 2 * 7] * gF2Dr_g_ompkernel[ind] + sx[m + 2 * 7] * gF2Ds_g_ompkernel[ind];
        Dy2[ind] = ry[m + 2 * 7] * gF2Dr_g_ompkernel[ind] + sy[m + 2 * 7] * gF2Ds_g_ompkernel[ind];
      }
    }
    //end inline func
  }
