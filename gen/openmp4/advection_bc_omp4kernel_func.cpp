...
void advection_bc_omp4_kernel(
  ...
  for ( int e=start; e<end; e++ ){
    ...
    const double *nu = &data6[10 * map4idx];
    const double *q0 = &data7[10 * map4idx];
    const double *q1 = &data8[10 * map4idx];
    double *exQ0 = &data9[12 * map4idx];
    double *exQ1 = &data10[12 * map4idx];
