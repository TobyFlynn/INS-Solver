...
void op_par_loop_init_gauss_grad3_2(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg,
...
void op_par_loop_init_gauss_grad4_2(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg,
...
void op_par_loop_init_gauss_grad5_2(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg,
...
bool PoissonSolve::solve(op_dat b_dat, op_dat x_dat) {
  op_par_loop_poisson_apply_bc("poisson_apply_bc",mesh->bedges,
              ...
              op_arg_dat(op_bc,-1,OP_ID,60,"double",OP_READ),
...
void PoissonSolve::calc_rhs(const double *u_d, double *rhs_d) {
  ...
  op_par_loop_poisson_cells("poisson_cells",mesh->cells,
              ...
              op_arg_dat(op1,-1,OP_ID,100,"double",OP_READ),
...
void PoissonSolve::precond(const double *in_d, double *out_d) {
  ...
  op_par_loop_poisson_pre("poisson_pre",mesh->cells,
              ...
              op_arg_dat(pre,-1,OP_ID,100,"double",OP_READ),
...
void PoissonSolve::set_sub_mat() {
  ...
  op_par_loop_init_gauss_grad("init_gauss_grad",mesh->cells,
              ...
              op_arg_dat(data->mDx[0],-1,OP_ID,60,"double",OP_WRITE),
              op_arg_dat(data->mDy[0],-1,OP_ID,60,"double",OP_WRITE),
              op_arg_dat(data->mDx[1],-1,OP_ID,60,"double",OP_WRITE),
              op_arg_dat(data->mDy[1],-1,OP_ID,60,"double",OP_WRITE),
              op_arg_dat(data->mDx[2],-1,OP_ID,60,"double",OP_WRITE),
              op_arg_dat(data->mDy[2],-1,OP_ID,60,"double",OP_WRITE));

  // gDnM = gnx*gDxM + gny*gDyM;
  op_par_loop_init_gauss_grad3_2("init_gauss_grad3_2",mesh->edges,
              ...
              op_arg_dat(data->mDx[0],0,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDx[0],1,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[0],0,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[0],1,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDx[1],0,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDx[1],1,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[1],0,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[1],1,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDx[2],0,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDx[2],1,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[2],0,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[2],1,mesh->edge2cells,60,"double",OP_READ),
              op_arg_dat(gFactor,0,mesh->edge2cells,18,"double",OP_READ),
              op_arg_dat(gFactor,1,mesh->edge2cells,18,"double",OP_READ),
              op_arg_dat(data->mDL,-1,OP_ID,60,"double",OP_WRITE),
              op_arg_dat(data->mDR,-1,OP_ID,60,"double",OP_WRITE));

  op_par_loop_init_gauss_grad4_2("init_gauss_grad4_2",mesh->bedges,
              op_arg_dat(mesh->bedgeNum,-1,OP_ID,1,"int",OP_READ),
              ...
              op_arg_dat(data->mDx[0],0,mesh->bedge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[0],0,mesh->bedge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDx[1],0,mesh->bedge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[1],0,mesh->bedge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDx[2],0,mesh->bedge2cells,60,"double",OP_READ),
              op_arg_dat(data->mDy[2],0,mesh->bedge2cells,60,"double",OP_READ),
              op_arg_dat(gFactor,0,mesh->bedge2cells,18,"double",OP_READ),
              op_arg_dat(data->mDBC,-1,OP_ID,60,"double",OP_WRITE));
  ...
  op_par_loop_init_gauss_grad5_2("init_gauss_grad5_2",mesh->edges,
              op_arg_dat(mesh->edgeNum,-1,OP_ID,2,"int",OP_READ),
              ...
              op_arg_dat(gFactor,0,mesh->edge2cells,18,"double",OP_READ),
              op_arg_dat(gFactor,1,mesh->edge2cells,18,"double",OP_READ),
              op_arg_dat(data->pDL,-1,OP_ID,60,"double",OP_WRITE),
              op_arg_dat(data->pDR,-1,OP_ID,60,"double",OP_WRITE));
}
...
void PoissonSolve::set_op() {
  ...
  op_par_loop_poisson_op1("poisson_op1",mesh->cells,
              ...
              op_arg_dat(data->Dy,-1,OP_ID,360,"double",OP_READ),
  ...
  op_par_loop_poisson_op2("poisson_op2",mesh->edges,
              op_arg_dat(mesh->edgeNum,-1,OP_ID,2,"int",OP_READ),
              op_arg_dat(mesh->reverse,-1,OP_ID,1,"bool",OP_READ),
              op_arg_dat(data->mDL,-1,OP_ID,60,"double",OP_READ),
              op_arg_dat(data->mDR,-1,OP_ID,60,"double",OP_READ),
              op_arg_dat(data->pDL,-1,OP_ID,60,"double",OP_READ),
              op_arg_dat(data->pDR,-1,OP_ID,60,"double",OP_READ),
              op_arg_dat(data->gVPL,-1,OP_ID,60,"double",OP_READ),
              op_arg_dat(data->gVPR,-1,OP_ID,60,"double",OP_READ),
              ...
              op_arg_dat(op1,0,mesh->edge2cells,100,"double",OP_INC),
              op_arg_dat(op1,1,mesh->edge2cells,100,"double",OP_INC),
  ...
  op_par_loop_poisson_op3("poisson_op3",mesh->bedges,
              ...
              op_arg_dat(data->mDBC,-1,OP_ID,60,"double",OP_READ),
  ...
  if(massMat) {
    op_par_loop_poisson_op4("poisson_op4",mesh->cells,
                ...
                op_arg_dat(op1,-1,OP_ID,100,"double",OP_INC),
                op_arg_dat(tmp,-1,OP_ID,100,"double",OP_WRITE));
  ...
  op_par_loop_poisson_op5("poisson_op5",mesh->bedges,
              ...
              op_arg_dat(gFactor,0,mesh->bedge2cells,18,"double",OP_READ),
              op_arg_dat(factor,0,mesh->bedge2cells,10,"double",OP_READ),
              op_arg_dat(op_bc,-1,OP_ID,60,"double",OP_WRITE));
}
