...
bool PoissonSolve::solve(op_dat b_dat, op_dat x_dat) {
  op_par_loop(poisson_apply_bc, "poisson_apply_bc", mesh->bedges,
              ...
              op_arg_dat(op_bc, -1, OP_ID, 4 * 6, "double", OP_READ),
...
void PoissonSolve::precond(const double *in_d, double *out_d) {
  ...
  op_par_loop(poisson_pre, "poisson_pre", mesh->cells,
              ...
              op_arg_dat(pre, -1, OP_ID, 6 * 6, "double", OP_READ),
...
void PoissonSolve::set_op() {
  op_par_loop(poisson_op1, "poisson_op1", mesh->cells,
              ...
              op_arg_dat(data->Dx, -1, OP_ID, 16 * 6, "double", OP_READ),
              op_arg_dat(data->Dy, -1, OP_ID, 16 * 6, "double", OP_READ),
              op_arg_dat(cFactor,  -1, OP_ID, 16, "double", OP_READ),
              op_arg_dat(op1,      -1, OP_ID, 6 * 6, "double", OP_WRITE));

  op_par_loop(poisson_op2, "poisson_op2", mesh->edges,
              op_arg_dat(mesh->edgeNum,  -1, OP_ID, 2, "int", OP_READ),
              op_arg_dat(mesh->reverse,  -1, OP_ID, 1, "bool", OP_READ),
              op_arg_dat(data->mD[0],     0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->mD[0],     1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->mD[1],     0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->mD[1],     1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->mD[2],     0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->mD[2],     1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pD[0],     0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pD[0],     1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pD[1],     0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pD[1],     1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pD[2],     0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pD[2],     1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pDy[0],    0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pDy[0],    1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pDy[1],    0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pDy[1],    1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pDy[2],    0, mesh->edge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->pDy[2],    1, mesh->edge2cells, 4 * 6, "double", OP_READ),
              ...
              op_arg_dat(op1,     0, mesh->edge2cells, 6 * 6, "double", OP_INC),
              op_arg_dat(op1,     1, mesh->edge2cells, 6 * 6, "double", OP_INC),
              op_arg_dat(op2[0], -1, OP_ID, 6 * 6, "double", OP_WRITE),
              op_arg_dat(op2[1], -1, OP_ID, 6 * 6, "double", OP_WRITE));
  ...
  op_par_loop(poisson_op3, "poisson_op3", mesh->bedges,
              ...
              op_arg_dat(data->mD[0],     0, mesh->bedge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->mD[1],     0, mesh->bedge2cells, 4 * 6, "double", OP_READ),
              op_arg_dat(data->mD[2],     0, mesh->bedge2cells, 4 * 6, "double", OP_READ),
              ...
              op_arg_dat(op1,             0, mesh->bedge2cells, 6 * 6, "double", OP_INC));

  if(massMat) {
    op_par_loop(poisson_op4, "poisson_op4", mesh->cells,
                op_arg_dat(mesh->cubature->mm, -1, OP_ID, 6 * 6, "double", OP_READ),
                op_arg_dat(mmFactor, -1, OP_ID, 6, "double", OP_READ),
                op_arg_dat(op1,      -1, OP_ID, 6 * 6, "double", OP_INC),
                op_arg_dat(tmp,      -1, OP_ID, 6 * 6, "double", OP_WRITE));
  ...
  op_par_loop(poisson_op5, "poisson_op5", mesh->bedges,
              ...
              op_arg_dat(gFactor,         0, mesh->bedge2cells, 12, "double", OP_READ),
              op_arg_dat(factor,          0, mesh->bedge2cells, 6, "double", OP_READ),
              op_arg_dat(op_bc,          -1, OP_ID, 4 * 6, "double", OP_WRITE));
}
