...
void op_par_loop_pressure_grad_flux(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      const double* arg8_vec[] = {
         &((double*)arg8.data)[6 * map2idx],
         &((double*)arg8.data)[6 * map3idx]};
      double* arg10_vec[] = {
  ...
  OP_kernels[37].transfer += (float)set->size * arg12.size * 2.0f;
  OP_kernels[37].transfer += (float)set->size * arg0.size;
  OP_kernels[37].transfer += (float)set->size * arg1.size;
  OP_kernels[37].transfer += (float)set->size * arg2.map->dim * 4.0f;
}
