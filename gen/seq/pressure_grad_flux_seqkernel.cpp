...
//user function
#include "../kernels/pressure_grad_flux.h"
...
void op_par_loop_pressure_grad_flux(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      const double* arg2_vec[] = {
         &((double*)arg2.data)[12 * map2idx],
         &((double*)arg2.data)[12 * map3idx]};
      const double* arg4_vec[] = {
         &((double*)arg4.data)[12 * map2idx],
         &((double*)arg4.data)[12 * map3idx]};
      const double* arg6_vec[] = {
         &((double*)arg6.data)[12 * map2idx],
         &((double*)arg6.data)[12 * map3idx]};
      const double* arg8_vec[] = {
         &((double*)arg8.data)[10 * map2idx],
         &((double*)arg8.data)[10 * map3idx]};
      double* arg10_vec[] = {
         &((double*)arg10.data)[12 * map2idx],
         &((double*)arg10.data)[12 * map3idx]};
      double* arg12_vec[] = {
         &((double*)arg12.data)[12 * map2idx],
         &((double*)arg12.data)[12 * map3idx]};
  ...
  OP_kernels[69].transfer += (float)set->size * arg10.size * 2.0f;
  OP_kernels[69].transfer += (float)set->size * arg12.size * 2.0f;
  OP_kernels[69].transfer += (float)set->size * arg0.size;
  OP_kernels[69].transfer += (float)set->size * arg1.size;
  OP_kernels[69].transfer += (float)set->size * arg2.map->dim * 4.0f;
}
