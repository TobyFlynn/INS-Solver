  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      const double* arg3_vec[] = {
         ...
         &((double*)arg3.data)[9 * map2idx]};
      const double* arg5_vec[] = {
         &((double*)arg5.data)[9 * map1idx],
         &((double*)arg5.data)[9 * map2idx]};
      const double* arg7_vec[] = {
         &((double*)arg7.data)[9 * map1idx],
         &((double*)arg7.data)[9 * map2idx]};
      const double* arg9_vec[] = {
         &((double*)arg9.data)[9 * map1idx],
         &((double*)arg9.data)[9 * map2idx]};
      const double* arg11_vec[] = {
         &((double*)arg11.data)[9 * map1idx],
         &((double*)arg11.data)[9 * map2idx]};
      double* arg13_vec[] = {
         &((double*)arg13.data)[9 * map1idx],
         &((double*)arg13.data)[9 * map2idx]};
      double* arg15_vec[] = {
         &((double*)arg15.data)[9 * map1idx],
         &((double*)arg15.data)[9 * map2idx]};
      double* arg17_vec[] = {
         &((double*)arg17.data)[9 * map1idx],
         &((double*)arg17.data)[9 * map2idx]};
      double* arg19_vec[] = {
         &((double*)arg19.data)[9 * map1idx],
         &((double*)arg19.data)[9 * map2idx]};
      double* arg21_vec[] = {
         &((double*)arg21.data)[9 * map1idx],
         &((double*)arg21.data)[9 * map2idx]};
      double* arg23_vec[] = {
         &((double*)arg23.data)[9 * map1idx],
         &((double*)arg23.data)[9 * map2idx]};
