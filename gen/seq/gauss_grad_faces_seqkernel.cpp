...
void op_par_loop_gauss_grad_faces(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      const double* arg1_vec[] = {
         &((double*)arg1.data)[60 * map1idx],
         &((double*)arg1.data)[60 * map2idx]};
      const double* arg3_vec[] = {
         &((double*)arg3.data)[60 * map1idx],
         &((double*)arg3.data)[60 * map2idx]};
      ...
      double* arg17_vec[] = {
         &((double*)arg17.data)[60 * map1idx],
         &((double*)arg17.data)[60 * map2idx]};
      double* arg19_vec[] = {
         &((double*)arg19.data)[60 * map1idx],
         &((double*)arg19.data)[60 * map2idx]};
      double* arg21_vec[] = {
         &((double*)arg21.data)[60 * map1idx],
         &((double*)arg21.data)[60 * map2idx]};
      double* arg23_vec[] = {
         &((double*)arg23.data)[60 * map1idx],
         &((double*)arg23.data)[60 * map2idx]};
  ...
  OP_kernels[11].transfer += (float)set->size * arg11.size;
  OP_kernels[11].transfer += (float)set->size * arg13.size * 2.0f;
  OP_kernels[11].transfer += (float)set->size * arg15.size * 2.0f;
  OP_kernels[11].transfer += (float)set->size * arg17.size * 2.0f;
  OP_kernels[11].transfer += (float)set->size * arg19.size * 2.0f;
  OP_kernels[11].transfer += (float)set->size * arg21.size * 2.0f;
  OP_kernels[11].transfer += (float)set->size * arg23.size * 2.0f;
  OP_kernels[11].transfer += (float)set->size * arg0.size;
  OP_kernels[11].transfer += (float)set->size * arg1.map->dim * 4.0f;
}
