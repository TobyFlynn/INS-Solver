...
void op_par_loop_advection_bc(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      advection_bc(
        ...
        &((double*)arg6.data)[3 * map4idx],
        &((double*)arg7.data)[3 * map4idx],
        &((double*)arg8.data)[3 * map4idx],
        &((double*)arg9.data)[6 * map4idx],
        &((double*)arg10.data)[6 * map4idx]);
    }
  }
  ...
  OP_kernels[30].transfer += (float)set->size * arg9.size * 2.0f;
  OP_kernels[30].transfer += (float)set->size * arg10.size * 2.0f;
  ...
  OP_kernels[30].transfer += (float)set->size * arg4.map->dim * 4.0f;
}
