  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      const double* arg8_vec[] = {
         &((double*)arg8.data)[12 * map2idx],
         &((double*)arg8.data)[12 * map3idx]};
      double* arg10_vec[] = {
      ...
      double* arg14_vec[] = {
         &((double*)arg14.data)[12 * map2idx],
         &((double*)arg14.data)[12 * map3idx]};
      double* arg16_vec[] = {
         &((double*)arg16.data)[12 * map2idx],
         &((double*)arg16.data)[12 * map3idx]};
