  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      pressure_bc(
        ...
        &((double*)arg6.data)[9 * map4idx],
        &((double*)arg7.data)[9 * map4idx],
        &((double*)arg8.data)[6 * map4idx],
        &((double*)arg9.data)[6 * map4idx],
        &((double*)arg10.data)[6 * map4idx],
        &((double*)arg11.data)[6 * map4idx],
        &((double*)arg12.data)[6 * map4idx],
        &((double*)arg13.data)[6 * map4idx],
        &((double*)arg14.data)[9 * map4idx]);
    }
  }
