...
void op_par_loop_poisson_op2(char const *name, op_set set,
  ...
  OP_kernels[19].transfer += (float)set->size * arg16.size * 2.0f;
  ...
  OP_kernels[19].transfer += (float)set->size * arg19.size;
  OP_kernels[19].transfer += (float)set->size * arg8.map->dim * 4.0f;
}
