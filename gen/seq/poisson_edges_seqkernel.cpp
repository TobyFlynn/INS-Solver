...
void op_par_loop_poisson_edges(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      poisson_edges(
        &((double*)arg0.data)[6 * map0idx],
        &((double*)arg1.data)[36 * n],
        &((double*)arg2.data)[6 * map0idx],
        &((double*)arg0.data)[6 * map3idx],
        &((double*)arg4.data)[36 * n],
  ...
  OP_kernels[17].transfer += (float)set->size * arg0.map->dim * 4.0f;
}
