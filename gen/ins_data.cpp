...
void INSData::init() {
  ...
  *****************************************************************************/
  ...
  op_par_loop(init_gauss_grad3, "init_gauss_grad3", mesh->edges,
              ...
              op_arg_dat(mDx[0], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDx[0], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[0], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[0], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDx[1], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDx[1], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[1], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[1], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDx[2], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDx[2], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[2], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[2], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDL, -1, OP_ID, 6 * 10, "double", OP_WRITE),
              op_arg_dat(mDR, -1, OP_ID, 6 * 10, "double", OP_WRITE));
  ...
  op_par_loop(init_gauss_grad4, "init_gauss_grad4", mesh->bedges,
              ...
              op_arg_dat(mDx[0], 0, mesh->bedge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[0], 0, mesh->bedge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDx[1], 0, mesh->bedge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[1], 0, mesh->bedge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDx[2], 0, mesh->bedge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDy[2], 0, mesh->bedge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(mDBC, -1, OP_ID, 6 * 10, "double", OP_WRITE));
  ...
  op_par_loop(init_gauss_grad3, "init_gauss_grad3", mesh->edges,
              ...
              op_arg_dat(mesh->gauss->ny, 0, mesh->edge2cells, 18, "double", OP_READ),
              op_arg_dat(mesh->gauss->ny, 1, mesh->edge2cells, 18, "double", OP_READ),
              op_arg_dat(pDx[0], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDx[0], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDy[0], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDy[0], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDx[1], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDx[1], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDy[1], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDy[1], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDx[2], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDx[2], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDy[2], 0, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDy[2], 1, mesh->edge2cells, 6 * 10, "double", OP_READ),
              op_arg_dat(pDL, -1, OP_ID, 6 * 10, "double", OP_WRITE),
              op_arg_dat(pDR, -1, OP_ID, 6 * 10, "double", OP_WRITE));

  op_par_loop(gauss_gfi_faces2, "gauss_gfi_faces2", mesh->edges,
              op_arg_dat(mesh->edgeNum, -1, OP_ID, 2, "int", OP_READ),
              op_arg_dat(mesh->reverse, -1, OP_ID, 1, "bool", OP_READ),
              op_arg_dat(gVPL, -1, OP_ID, 6 * 10, "double", OP_WRITE),
              op_arg_dat(gVPR, -1, OP_ID, 6 * 10, "double", OP_WRITE));
}
