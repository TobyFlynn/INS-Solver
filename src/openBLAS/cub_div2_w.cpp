...
inline void openblas_cub_div2_w(const int numCells, const double *temp0, const double *temp1,
...
void cub_div_w_blas2(INSData *data, CubatureData *cubatureData, op_dat res) {
  ...
  openblas_cub_div2_w(data->numCells, (double *)cubatureData->op_temps[0]->data,
