...
inline void openblas_cub_div_w(const int numCells, const double *in0, const double *in1,
...
void cub_div_w_blas(INSData *data, CubatureData *cubatureData, op_dat u, op_dat v) {
  ...
  op_mpi_halo_exchanges(data->cells, 4, v_args);

  openblas_cub_div_w(data->numCells, (double *)u->data, (double *)v->data,
                   (double *)cubatureData->op_temps[0]->data, (double *)cubatureData->op_temps[1]->data);

  // Set correct dirty bits for OP2
  op_mpi_set_dirtybit(4, v_args);
}
