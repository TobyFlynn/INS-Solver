...
inline void openblas_cub_div2(const int numCells, const double *temp0, const double *temp1,
  ...
  cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 15, numCells, 46, 1.0, cubDr, 15, temp0, 46, 0.0, res, 15);
  cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 15, numCells, 46, 1.0, cubDs, 15, temp1, 46, 1.0, res, 15);

  cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 15, numCells, 46, 1.0, cubDr, 15, temp2, 46, 1.0, res, 15);
  cblas_dgemm(CblasColMajor, CblasNoTrans, CblasNoTrans, 15, numCells, 46, 1.0, cubDs, 15, temp3, 46, 1.0, res, 15);
}
