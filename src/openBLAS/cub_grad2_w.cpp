...
inline void openblas_cub_grad2_w(const int numCells, const double *temp0, const double *temp1,
...
void cub_grad_w_blas2(INSData *data, CubatureData *cubatureData, op_dat ux, op_dat uy) {
  ...
  openblas_cub_grad2_w(data->numCells, (double *)cubatureData->op_temps[0]->data,
