...
void op_par_loop_poisson_set_rhs_bc(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg,
...
void op_par_loop_poisson_set_rhs1(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg,
...
void op_par_loop_poisson_set_rhs2(char const *, op_set,
  op_arg,
  op_arg,
  op_arg,
  op_arg,
...
void Poisson::set_rhs(op_dat b) {
  op_par_loop_poisson_set_rhs_bc("poisson_set_rhs_bc",data->bedges,
  ...
  op_par_loop_poisson_set_rhs1("poisson_set_rhs1",data->cells,
  ...
  op_par_loop_poisson_set_rhs2("poisson_set_rhs2",data->cells,
