...
KDTree3DMPIAlpha::KDTree3DMPIAlpha(const DG_FP *x, const DG_FP *y, const DG_FP *z,
  ...
  timer->endTimer("KDTree3DMPIAlpha - init");
}

DG_FP KDTree3DMPIAlpha::min_dist_bb(const DG_FP *min_0, const DG_FP *max_0,
...
void KDTree3DMPIAlpha::build_tree() {
  ...
  timer->endTimer("KDTree3DMPIAlpha - comm");

  timer->startTimer("KDTree3DMPIAlpha - unpack");
  // Unpack data
  int curr_rank = 0;
  ...
  timer->endTimer("KDTree3DMPIAlpha - unpack");
