...
void CompressibleEulerSolver2D::rhs(op_dat *wQ, op_dat *RHSQ) {
  ...
  op_par_loop(euler_2d_faces, "euler_2d_faces", mesh->faces,
              ...
              op_arg_dat(gQ[0],    -2, mesh->face2cells, DG_G_NP, "double", OP_READ),
              op_arg_dat(gQ[1],    -2, mesh->face2cells, DG_G_NP, "double", OP_READ),
              op_arg_dat(gQ[2],    -2, mesh->face2cells, DG_G_NP, "double", OP_READ),
              op_arg_dat(gQ[3],    -2, mesh->face2cells, DG_G_NP, "double", OP_READ),
              op_arg_dat(gRHSQ[0], -2, mesh->face2cells, DG_G_NP, "double", OP_INC),
              op_arg_dat(gRHSQ[1], -2, mesh->face2cells, DG_G_NP, "double", OP_INC),
              op_arg_dat(gRHSQ[2], -2, mesh->face2cells, DG_G_NP, "double", OP_INC),
              op_arg_dat(gRHSQ[3], -2, mesh->face2cells, DG_G_NP, "double", OP_INC));
...
double CompressibleEulerSolver2D::l2_vortex_error(double time) {
