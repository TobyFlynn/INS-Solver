...
void op_par_loop_gauss_op(char const *name, op_set set,
  ...
  OP_kernels[15].transfer += (float)set->size * arg11.size * 2.0f;
  OP_kernels[15].transfer += (float)set->size * arg12.size * 2.0f;
  OP_kernels[15].transfer += (float)set->size * arg13.size * 2.0f;
  OP_kernels[15].transfer += (float)set->size * arg14.size * 2.0f;
  OP_kernels[15].transfer += (float)set->size * arg15.size * 2.0f;
