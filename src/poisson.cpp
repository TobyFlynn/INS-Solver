...
bool PoissonSolve::solve(op_dat b_dat, op_dat x_dat) {
  op_par_loop(poisson_apply_bc, "poisson_apply_bc", data->bedges,
...
void PoissonSolve::calc_rhs(const double *u_d, double *rhs_d) {
  ...
  op_par_loop(poisson_cells, "poisson_cells", data->cells,
  ...
  op_par_loop(poisson_edges, "poisson_edges", data->edges,
...
void PoissonSolve::set_op() {
  op_par_loop(poisson_op1, "poisson_op1", data->cells,
  ...
  op_par_loop(poisson_op2, "poisson_op2", data->edges,
  ...
  op_par_loop(poisson_op3, "poisson_op3", data->bedges,
  ...
  if(massMat) {
    op_par_loop(poisson_op4, "poisson_op4", data->cells,
  ...
  op_par_loop(poisson_op5, "poisson_op5", data->bedges,
              op_arg_dat(data->bedge_type, -1, OP_ID, 1, "int", OP_READ),
              op_arg_dat(data->bedgeNum, -1, OP_ID, 1, "int", OP_READ),
              op_arg_gbl(&dirichlet[0], 1, "int", OP_READ),
              op_arg_gbl(&dirichlet[1], 1, "int", OP_READ),
...
void PressureSolve::setup() {
  ...
  op_par_loop(pressure_solve_setup, "pressure_solve_setup", data->cells,
...
void ViscositySolve::setup(double mmConst) {
  ...
  op_par_loop(viscosity_solve_setup, "viscosity_solve_setup", data->cells,
