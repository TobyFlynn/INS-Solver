...
bool PressureSolve::solve(op_dat b_dat, op_dat x_dat) {
  ...
  op_par_loop(pressure_solve_apply_bc, "pressure_solve_apply_bc", data->bedges,
...
void PressureSolve::calc_rhs(const double *u_d, double *rhs_d) {
  ...
  op_par_loop(pressure_solve_1, "pressure_solve_1", data->edges,
              op_arg_dat(data->edgeNum, -1, OP_ID, 2, "int", OP_READ),
              op_arg_dat(data->reverse, -1, OP_ID, 1, "bool", OP_READ),
              op_arg_dat(gData->mD[0], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->mD[1], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->mD[2], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->pD[0], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->pD[1], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->pD[2], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->pDy[0], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->pDy[1], -2, data->edge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(gData->pDy[2], -2, data->edge2cells, 7 * 15, "double", OP_READ),
  ...
  op_par_loop(pressure_solve_2, "pressure_solve_2", data->bedges,
              op_arg_dat(data->bedge_type, -1, OP_ID, 1, "int", OP_READ),
              op_arg_dat(data->bedgeNum, -1, OP_ID, 1, "int", OP_READ),
              op_arg_gbl(&dirichlet[0], 1, "int", OP_READ),
              op_arg_gbl(&dirichlet[1], 1, "int", OP_READ),
