...
//user function
#include "../kernels/poisson_mf_bedges.h"
...
void op_par_loop_poisson_mf_bedges(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      poisson_mf_bedges(
        ...
        &((double*)arg7.data)[21 * map5idx],
        &((double*)arg8.data)[3 * map5idx],
        &((double*)arg9.data)[21 * map5idx],
  ...
  OP_kernels[34].transfer += (float)set->size * arg12.size * 2.0f;
  OP_kernels[34].transfer += (float)set->size * arg13.size * 2.0f;
  ...
  OP_kernels[34].transfer += (float)set->size * arg5.map->dim * 4.0f;
}
