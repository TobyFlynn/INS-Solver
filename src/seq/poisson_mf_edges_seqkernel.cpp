...
void op_par_loop_poisson_mf_edges(char const *name, op_set set,
  ...
  OP_kernels[30].transfer += (float)set->size * arg16.size * 2.0f;
  OP_kernels[30].transfer += (float)set->size * arg18.size * 2.0f;
  OP_kernels[30].transfer += (float)set->size * arg20.size * 2.0f;
