...
void op_par_loop_poisson_mf2_bc(char const *name, op_set set,
  ...
  OP_kernels[55].transfer += (float)set->size * arg9.size;
  ...
  OP_kernels[55].transfer += (float)set->size * arg11.size * 2.0f;
  OP_kernels[55].transfer += (float)set->size * arg6.map->dim * 4.0f;
}
