...
void op_par_loop_poisson_op5(char const *name, op_set set,
  ...
  OP_kernels[22].transfer += (float)set->size * arg11.size;
  ...
  OP_kernels[22].transfer += (float)set->size * arg12.size;
  OP_kernels[22].transfer += (float)set->size * arg5.map->dim * 4.0f;
}
