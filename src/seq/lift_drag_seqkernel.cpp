...
void op_par_loop_lift_drag(char const *name, op_set set,
  ...
  OP_kernels[64].transfer += (float)set->size * arg5.size;
  ...
  OP_kernels[64].transfer += (float)set->size * arg0.size;
  OP_kernels[64].transfer += (float)set->size * arg1.size;
  OP_kernels[64].transfer += (float)set->size * arg11.size * 2.0f;
  OP_kernels[64].transfer += (float)set->size * arg12.size * 2.0f;
  OP_kernels[64].transfer += (float)set->size * arg2.map->dim * 4.0f;
}
