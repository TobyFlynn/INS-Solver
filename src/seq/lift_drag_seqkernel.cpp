...
void op_par_loop_lift_drag(char const *name, op_set set,
  ...
  OP_kernels[49].transfer += (float)set->size * arg9.size;
  ...
  OP_kernels[49].transfer += (float)set->size * arg11.size * 2.0f;
  OP_kernels[49].transfer += (float)set->size * arg12.size * 2.0f;
