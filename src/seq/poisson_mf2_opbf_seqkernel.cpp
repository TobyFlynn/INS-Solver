...
void op_par_loop_poisson_mf2_opbf(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int n=0; n<set_size; n++ ){
      ...
      poisson_mf2_opbf(
        ...
        (int*)arg4.data,
        (int*)arg5.data,
        &((double*)arg6.data)[225 * map6idx],
        &((double*)arg7.data)[225 * map6idx],
        &((double*)arg8.data)[225 * map6idx],
        &((double*)arg9.data)[225 * map6idx]);
    }
  }
  ...
  OP_kernels[54].transfer += (float)set->size * arg6.map->dim * 4.0f;
}
