...
//user function
#include "../kernels/viscosity_solve_1.h"
...
void op_par_loop_viscosity_solve_1(char const *name, op_set set,
  ...
  OP_kernels[32].transfer += (float)set->size * arg14.size;
  OP_kernels[32].transfer += (float)set->size * arg16.size;
  OP_kernels[32].transfer += (float)set->size * arg18.size;
  OP_kernels[32].transfer += (float)set->size * arg20.size;
  OP_kernels[32].transfer += (float)set->size * arg22.size;
  OP_kernels[32].transfer += (float)set->size * arg24.size;
  OP_kernels[32].transfer += (float)set->size * arg26.size;
  OP_kernels[32].transfer += (float)set->size * arg28.size;
  OP_kernels[32].transfer += (float)set->size * arg30.size;
  OP_kernels[32].transfer += (float)set->size * arg32.size;
  OP_kernels[32].transfer += (float)set->size * arg34.size * 2.0f;
  OP_kernels[32].transfer += (float)set->size * arg0.size;
  OP_kernels[32].transfer += (float)set->size * arg1.size;
  OP_kernels[32].transfer += (float)set->size * arg2.map->dim * 4.0f;
}
