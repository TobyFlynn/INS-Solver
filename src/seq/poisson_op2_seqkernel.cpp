...
void op_par_loop_poisson_op2(char const *name, op_set set,
  ...
  OP_kernels[17].transfer += (float)set->size * arg6.size;
  OP_kernels[17].transfer += (float)set->size * arg8.size;
  OP_kernels[17].transfer += (float)set->size * arg10.size;
  OP_kernels[17].transfer += (float)set->size * arg12.size;
  OP_kernels[17].transfer += (float)set->size * arg14.size;
  OP_kernels[17].transfer += (float)set->size * arg16.size;
  OP_kernels[17].transfer += (float)set->size * arg18.size;
  OP_kernels[17].transfer += (float)set->size * arg20.size;
  OP_kernels[17].transfer += (float)set->size * arg22.size;
  OP_kernels[17].transfer += (float)set->size * arg24.size;
  OP_kernels[17].transfer += (float)set->size * arg26.size;
  OP_kernels[17].transfer += (float)set->size * arg28.size * 2.0f;
  OP_kernels[17].transfer += (float)set->size * arg0.size;
  OP_kernels[17].transfer += (float)set->size * arg1.size;
  OP_kernels[17].transfer += (float)set->size * arg30.size;
  OP_kernels[17].transfer += (float)set->size * arg31.size;
  OP_kernels[17].transfer += (float)set->size * arg2.map->dim * 4.0f;
}
