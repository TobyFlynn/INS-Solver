...
void op_par_loop_pressure_bc(char const *name, op_set set,
  ...
  OP_kernels[46].transfer += (float)set->size * arg6.size;
  OP_kernels[46].transfer += (float)set->size * arg7.size;
  OP_kernels[46].transfer += (float)set->size * arg8.size;
  OP_kernels[46].transfer += (float)set->size * arg9.size;
  OP_kernels[46].transfer += (float)set->size * arg10.size;
  OP_kernels[46].transfer += (float)set->size * arg11.size;
  OP_kernels[46].transfer += (float)set->size * arg12.size;
  OP_kernels[46].transfer += (float)set->size * arg13.size * 2.0f;
  ...
  OP_kernels[46].transfer += (float)set->size * arg4.map->dim * 4.0f;
}
