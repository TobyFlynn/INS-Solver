...
void op_par_loop_pressure_bc(char const *name, op_set set,
  ...
  OP_kernels[44].transfer += (float)set->size * arg8.size;
  OP_kernels[44].transfer += (float)set->size * arg9.size;
  OP_kernels[44].transfer += (float)set->size * arg10.size;
  OP_kernels[44].transfer += (float)set->size * arg11.size;
  OP_kernels[44].transfer += (float)set->size * arg12.size;
  OP_kernels[44].transfer += (float)set->size * arg13.size;
  OP_kernels[44].transfer += (float)set->size * arg14.size * 2.0f;
