...
void op_par_loop_gauss_grad_faces(char const *name, op_set set,
  ...
  OP_kernels[8].transfer += (float)set->size * arg13.size * 2.0f;
  OP_kernels[8].transfer += (float)set->size * arg15.size * 2.0f;
  OP_kernels[8].transfer += (float)set->size * arg17.size * 2.0f;
  OP_kernels[8].transfer += (float)set->size * arg19.size * 2.0f;
  OP_kernels[8].transfer += (float)set->size * arg21.size * 2.0f;
  OP_kernels[8].transfer += (float)set->size * arg23.size * 2.0f;
