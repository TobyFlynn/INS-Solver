...
void op_par_loop_ls_add_diff(char const *name, op_set set,
  ...
  OP_kernels[64].transfer += (float)set->size * arg1.size * 2.0f;
  OP_kernels[64].transfer += (float)set->size * arg2.size * 2.0f;
  OP_kernels[64].transfer += (float)set->size * arg3.size * 2.0f;
  OP_kernels[64].transfer += (float)set->size * arg4.size * 2.0f;
