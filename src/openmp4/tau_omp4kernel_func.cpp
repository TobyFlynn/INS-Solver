...
void tau_omp4_kernel(
  ...
  for ( int e=start; e<end; e++ ){
    ...
    const double **J = arg1_vec;
    const double **sJ = arg3_vec;
    double **tau = arg5_vec;
    ...
    double hminL = 2.0 * J[0][FMASK_ompkernel[edgeL * 5]] / sJ[0][edgeL * 5];
    double hminR = 2.0 * J[1][FMASK_ompkernel[edgeR * 5]] / sJ[1][edgeR * 5];
