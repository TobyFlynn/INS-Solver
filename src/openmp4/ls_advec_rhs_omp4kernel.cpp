...
void op_par_loop_ls_advec_rhs(char const *name, op_set set,
  ...
  OP_kernels[60].transfer += (float)set->size * arg9.size * 2.0f;
  OP_kernels[60].transfer += (float)set->size * arg10.size;
  OP_kernels[60].transfer += (float)set->size * arg11.size;
  OP_kernels[60].transfer += (float)set->size * arg12.size;
  OP_kernels[60].transfer += (float)set->size * arg13.size;
  OP_kernels[60].transfer += (float)set->size * arg14.size;
  OP_kernels[60].transfer += (float)set->size * arg15.size * 2.0f;
  OP_kernels[60].transfer += (float)set->size * arg16.size * 2.0f;
}
