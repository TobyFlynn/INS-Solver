...
void op_par_loop_ls_advec_rhs(char const *name, op_set set,
  ...
  #ifdef OP_PART_SIZE_69
    int part_size = OP_PART_SIZE_69;
  #else
  ...
  OP_kernels[69].transfer += (float)set->size * arg0.size;
  OP_kernels[69].transfer += (float)set->size * arg1.size;
  OP_kernels[69].transfer += (float)set->size * arg2.size;
  OP_kernels[69].transfer += (float)set->size * arg3.size;
  OP_kernels[69].transfer += (float)set->size * arg4.size;
  OP_kernels[69].transfer += (float)set->size * arg5.size;
  OP_kernels[69].transfer += (float)set->size * arg6.size;
  OP_kernels[69].transfer += (float)set->size * arg7.size;
  OP_kernels[69].transfer += (float)set->size * arg8.size;
  OP_kernels[69].transfer += (float)set->size * arg9.size * 2.0f;
  OP_kernels[69].transfer += (float)set->size * arg10.size;
  OP_kernels[69].transfer += (float)set->size * arg11.size;
  OP_kernels[69].transfer += (float)set->size * arg12.size;
  OP_kernels[69].transfer += (float)set->size * arg13.size;
  OP_kernels[69].transfer += (float)set->size * arg14.size;
  OP_kernels[69].transfer += (float)set->size * arg15.size * 2.0f;
  OP_kernels[69].transfer += (float)set->size * arg16.size * 2.0f;
}
