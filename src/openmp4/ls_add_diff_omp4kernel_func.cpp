...
void ls_add_diff_omp4_kernel(
  ...
  for ( int n_op=0; n_op<count; n_op++ ){
    //variable mapping
    const double *diff = &data0[15*n_op];
    double *rk = &data1[15*n_op];
    double *dsldx = &data2[21*n_op];
    double *dsrdx = &data3[21*n_op];
    double *dsldy = &data4[21*n_op];
    double *dsrdy = &data5[21*n_op];
