...
void poisson_rhs_bc_omp4_kernel(
  ...
  #pragma omp target teams num_teams(num_teams) thread_limit(nthread) map(to:data0[0:dat0size],data1[0:dat1size]) \
    ...
    map(to:col_reord[0:set_size1],map5[0:map5size],data5[0:dat5size],data6[0:dat6size],data7[0:dat7size])
  ...
  for ( int e=start; e<end; e++ ){
    ...
    const double *dBC = &data5[15 * map5idx];
    const double *U = &data6[15 * map5idx];
    double *exU = &data7[15 * map5idx];
