...
void ls_rhs_omp4_kernel(
  ...
  for ( int n_op=0; n_op<count; n_op++ ){
    //variable mapping
    const double *sign = &data0[15*n_op];
    const double *dpldx = &data1[15*n_op];
    const double *dprdx = &data2[15*n_op];
    const double *dpldy = &data3[15*n_op];
    const double *dprdy = &data4[15*n_op];
    double *rk = &data5[15*n_op];
