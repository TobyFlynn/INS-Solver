...
Poisson_MF2::Poisson_MF2(DGMesh *m, INSData *nsData, CubatureData *cubData, GaussData *gaussData) : Poisson(m, nsData, cubData, gaussData) {
  ...
  u_t_data    = (double *)calloc(DG_NP * mesh->numCells, sizeof(double));
  rhs_t_data  = (double *)calloc(DG_NP * mesh->numCells, sizeof(double));

  u      = op_decl_dat(mesh->cells, DG_NP, "double", u_data, "poisson_u");
  rhs    = op_decl_dat(mesh->cells, DG_NP, "double", rhs_data, "poisson_rhs");
  u_t    = op_decl_dat(mesh->cells, DG_NP, "double", u_t_data, "poisson_u_t");
  rhs_t  = op_decl_dat(mesh->cells, DG_NP, "double", rhs_t_data, "poisson_rhs_t");
...
void Poisson_MF2::setOp() {
  ...
  op_par_loop(poisson_mf2_opf, "poisson_mf2_opf", mesh->edges,
              ...
              op_arg_dat(op2[0], -1, OP_ID, DG_NP * DG_NP, "double", OP_INC),
              ...
              op_arg_dat(op2[1], -1, OP_ID, DG_NP * DG_NP, "double", OP_INC),
...
void Poisson_MF2::setBCOP() {
  ...
  op_par_loop(poisson_mf2_bc, "poisson_mf2_bc", mesh->bedges,
              ...
              op_arg_dat(op_bc, -1, OP_ID, DG_GF_NP * DG_NP, "double", OP_INC));
}
