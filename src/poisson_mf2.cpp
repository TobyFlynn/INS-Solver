...
Poisson_MF2::Poisson_MF2(INSData *insData, DGMesh *m) : Poisson(insData, m) {
  mesh = m;
...
void Poisson_MF2::setBCOP() {
  ...
  op_par_loop(poisson_mf2_bc, "poisson_mf2_bc", mesh->bedges,
              ...
              op_arg_gbl(&dirichlet[1], 1, "int", OP_READ),
              op_arg_gbl(&dirichlet[2], 1, "int", OP_READ),
              op_arg_dat(data->gmD[0], 0, mesh->bedge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(data->gmD[1], 0, mesh->bedge2cells, 7 * 15, "double", OP_READ),
              op_arg_dat(data->gmD[2], 0, mesh->bedge2cells, 7 * 15, "double", OP_READ),
