inline void poisson_matrix_3d_op2(const int **order, const double *dr,
                                  ...
                                  const double **tz, double *op1L, double *op1R,
  ...
  const int dg_np  = DG_CONSTANTS[(p - 1) * 2];
  const int dg_npf = DG_CONSTANTS[(p - 1) * 2 + 1];
