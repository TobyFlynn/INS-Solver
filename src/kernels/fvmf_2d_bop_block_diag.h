inline void fvmf_2d_bop_block_diag(const int *faceNum, const int *u_bc_type, const int *v_bc_type, const DG_FP *nx,
                        const DG_FP *ny, const DG_FP *fscale, const DG_FP *sJ,
                        const DG_FP *geof, const DG_FP *factor, DG_FP *u_op1, DG_FP *v_op1) {
