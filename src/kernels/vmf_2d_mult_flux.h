inline void vmf_2d_mult_flux(const DG_FP *nx, const DG_FP *ny, const DG_FP *sJ, 
                             const DG_FP *tau, DG_FP *u_jump, DG_FP *u_x_avg, 
                             DG_FP *u_y_avg, DG_FP *v_jump, DG_FP *v_x_avg, 
                             DG_FP *v_y_avg) {
