...
void INSData::initOP2() {
  ...
  op_decl_const(7*15, "double", gF0DrR);
  op_decl_const(7*15, "double", gF0DsR);
  op_decl_const(7*15, "double", gF1DrR);
  op_decl_const(7*15, "double", gF1DsR);
  op_decl_const(7*15, "double", gF2DrR);
  op_decl_const(7*15, "double", gF2DsR);
