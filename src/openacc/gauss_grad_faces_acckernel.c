...
//user function
//#pragma acc routine
inline void gauss_grad_faces_openacc( const int *edgeNum, const double **x,
...
void op_par_loop_gauss_grad_faces(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      #pragma acc parallel loop independent deviceptr(col_reord,map1,data0,data1,data3,data5,data7,data9,data11,data13,data15,data17,data19,data21,data23,data25,data27)
