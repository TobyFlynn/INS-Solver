...
//user function
//#pragma acc routine
inline void ls_bflux_openacc( const int *bedgeNum, const double *sJ, const double *nx,
...
void op_par_loop_ls_bflux(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      #pragma acc parallel loop independent deviceptr(col_reord,map1,data0,data1,data2,data3,data4,data5,data6,data7,data8)
