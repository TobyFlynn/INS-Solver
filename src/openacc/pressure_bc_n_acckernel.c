...
//user function
//#pragma acc routine
inline void pressure_bc_n_openacc( const int *bedge_type, const int *bedgeNum, const double *t,
...
void op_par_loop_pressure_bc_n(char const *name, op_set set,
  ...
  if (set_size >0) {
    ...
    for ( int col=0; col<Plan->ncolors; col++ ){
      ...
      #pragma acc parallel loop independent deviceptr(col_reord,map3,data0,data1,data3,data4,data5,data6,data7,data8,data9,data10,data11,data12)
