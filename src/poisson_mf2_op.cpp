...
void Poisson_MF2::setOp() {
  ...
  op_par_loop_poisson_mf2_opf("poisson_mf2_opf",mesh->edges,
              ...
              op_arg_dat(gData->OP[0],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OP[1],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OP[2],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OPf[0],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OPf[1],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OPf[2],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(op2[0],-1,OP_ID,225,"double",OP_INC),
              op_arg_dat(op1,0,mesh->edge2cells,225,"double",OP_INC),
              op_arg_dat(gData->OP[0],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OP[1],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OP[2],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OPf[0],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OPf[1],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OPf[2],1,mesh->edge2cells,225,"double",OP_READ),
  ...
  op_par_loop_poisson_mf2_opbf("poisson_mf2_opbf",mesh->bedges,
              ...
              op_arg_dat(gData->OP[0],0,mesh->bedge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OP[1],0,mesh->bedge2cells,225,"double",OP_READ),
              op_arg_dat(gData->OP[2],0,mesh->bedge2cells,225,"double",OP_READ),
...
void Poisson_MF2::setBCOP() {
  ...
  op_par_loop_poisson_mf2_bc("poisson_mf2_bc",mesh->bedges,
              ...
              op_arg_gbl(&dirichlet[1],1,"int",OP_READ),
              op_arg_gbl(&dirichlet[2],1,"int",OP_READ),
              op_arg_dat(gData->mD[0],0,mesh->bedge2cells,105,"double",OP_READ),
              op_arg_dat(gData->mD[1],0,mesh->bedge2cells,105,"double",OP_READ),
              op_arg_dat(gData->mD[2],0,mesh->bedge2cells,105,"double",OP_READ),
