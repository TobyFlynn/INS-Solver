...
bool Poisson_MF2::solve(op_dat b_dat, op_dat x_dat, bool addMass, double factor) {
  ...
  if(massMat) {
    ...
    op_par_loop_poisson_mf2_apply_bc_vis("poisson_mf2_apply_bc_vis",mesh->bedges,
    ...
    op_par_loop_poisson_mf2_apply_bc("poisson_mf2_apply_bc",mesh->bedges,
                op_arg_dat(mesh->bedgeNum,-1,OP_ID,1,"int",OP_READ),
                op_arg_dat(op_bc,-1,OP_ID,105,"double",OP_READ),
                op_arg_dat(bc_dat,0,mesh->bedge2cells,21,"double",OP_READ),
                op_arg_dat(b_dat,0,mesh->bedge2cells,15,"double",OP_INC));
...
void Poisson_MF2::calc_rhs(const double *u_d, double *rhs_d) {
  ...
  if(massMat) {
    op_par_loop_poisson_mf2_mass("poisson_mf2_mass",mesh->cells,
    ...
    op_par_loop_poisson_mf2_vis("poisson_mf2_vis",mesh->cells,
    ...
    op_par_loop_poisson_mf2_faces_vis("poisson_mf2_faces_vis",mesh->edges,
    ...
    op_par_loop_poisson_mf2("poisson_mf2",mesh->cells,
                op_arg_dat(u,-1,OP_ID,15,"double",OP_READ),
                op_arg_dat(op1,-1,OP_ID,225,"double",OP_READ),
                op_arg_dat(rhs,-1,OP_ID,15,"double",OP_WRITE));

    op_par_loop_poisson_mf2_faces("poisson_mf2_faces",mesh->edges,
                op_arg_dat(u,0,mesh->edge2cells,15,"double",OP_READ),
                op_arg_dat(op2[0],-1,OP_ID,225,"double",OP_READ),
                op_arg_dat(rhs,0,mesh->edge2cells,15,"double",OP_INC),
                op_arg_dat(u,1,mesh->edge2cells,15,"double",OP_READ),
...
void Poisson_MF2::setOp() {
  ...
  op_par_loop_poisson_mf2_op("poisson_mf2_op",mesh->cells,
              op_arg_dat(data->cOP,-1,OP_ID,225,"double",OP_READ),
              op_arg_gbl(&tol,1,"double",OP_READ),
              op_arg_dat(op1,-1,OP_ID,225,"double",OP_WRITE));

  op_par_loop_poisson_mf2_opf("poisson_mf2_opf",mesh->edges,
              op_arg_gbl(&tol,1,"double",OP_READ),
              op_arg_dat(mesh->edgeNum,-1,OP_ID,2,"int",OP_READ),
              op_arg_dat(data->gOP[0],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOP[1],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOP[2],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOPf[0],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOPf[1],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOPf[2],0,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(op2[0],-1,OP_ID,225,"double",OP_INC),
              op_arg_dat(op1,0,mesh->edge2cells,225,"double",OP_INC),
              op_arg_dat(data->gOP[0],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOP[1],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOP[2],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOPf[0],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOPf[1],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOPf[2],1,mesh->edge2cells,225,"double",OP_READ),
              op_arg_dat(op2[1],-1,OP_ID,225,"double",OP_INC),
              op_arg_dat(op1,1,mesh->edge2cells,225,"double",OP_INC));

  op_par_loop_poisson_mf2_opbf("poisson_mf2_opbf",mesh->bedges,
              op_arg_gbl(&tol,1,"double",OP_READ),
              ...
              op_arg_dat(data->gOP[0],0,mesh->bedge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOP[1],0,mesh->bedge2cells,225,"double",OP_READ),
              op_arg_dat(data->gOP[2],0,mesh->bedge2cells,225,"double",OP_READ),
...
void Poisson_MF2::setBCOP() {
  ...
  op_par_loop_poisson_mf2_bc("poisson_mf2_bc",mesh->bedges,
              op_arg_gbl(&tol,1,"double",OP_READ),
              op_arg_dat(mesh->bedge_type,-1,OP_ID,1,"int",OP_READ),
              op_arg_dat(mesh->bedgeNum,-1,OP_ID,1,"int",OP_READ),
              op_arg_gbl(&dirichlet[0],1,"int",OP_READ),
