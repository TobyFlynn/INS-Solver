...
//user function
__device__ void cub_div_w_gpu( double *temp0, double *temp1, const double *rx, const double *sx,
...
__global__ void op_cuda_cub_div_w(
  double *arg0,
  double *arg1,
...
void op_par_loop_cub_div_w(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_cub_div_w<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
