...
__global__ void op_cuda_poisson_rhs_qbc(
  ...
  if (tid + start < end) {
    ...
    poisson_rhs_qbc_gpu(arg0+n*1,
                    ...
                    ind_arg0+map5idx*15,
                    arg6_l);
    atomicAdd(&ind_arg1[0+map5idx*15],arg6_l[0]);
    atomicAdd(&ind_arg1[1+map5idx*15],arg6_l[1]);
    atomicAdd(&ind_arg1[2+map5idx*15],arg6_l[2]);
    atomicAdd(&ind_arg1[3+map5idx*15],arg6_l[3]);
    atomicAdd(&ind_arg1[4+map5idx*15],arg6_l[4]);
    atomicAdd(&ind_arg1[5+map5idx*15],arg6_l[5]);
    atomicAdd(&ind_arg1[6+map5idx*15],arg6_l[6]);
    atomicAdd(&ind_arg1[7+map5idx*15],arg6_l[7]);
    atomicAdd(&ind_arg1[8+map5idx*15],arg6_l[8]);
    atomicAdd(&ind_arg1[9+map5idx*15],arg6_l[9]);
    atomicAdd(&ind_arg1[10+map5idx*15],arg6_l[10]);
    atomicAdd(&ind_arg1[11+map5idx*15],arg6_l[11]);
    atomicAdd(&ind_arg1[12+map5idx*15],arg6_l[12]);
    atomicAdd(&ind_arg1[13+map5idx*15],arg6_l[13]);
    atomicAdd(&ind_arg1[14+map5idx*15],arg6_l[14]);
  }
}
