...
//user function
__device__ void pressure_rhs_n_gpu( const double *b0, const double *b1, const double *g0,
...
__global__ void op_cuda_pressure_rhs_n(
  const double *arg0,
  const double *arg1,
  const double *arg2,
  const double *arg3,
...
void op_par_loop_pressure_rhs_n(char const *name, op_set set,
  ...
  if (set_size > 0) {
    ...
    op_cuda_pressure_rhs_n<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
