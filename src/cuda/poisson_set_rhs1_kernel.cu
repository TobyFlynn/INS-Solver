...
//user function
__device__ void poisson_set_rhs1_gpu( const double *nx, const double *ny, const double *sJ,
...
__global__ void op_cuda_poisson_set_rhs1(
  ...
  for ( int n=threadIdx.x+blockIdx.x*blockDim.x; n<set_size; n+=blockDim.x*gridDim.x ){
    ...
    poisson_set_rhs1_gpu(arg0+n*15,
                     arg1+n*15,
                     arg2+n*15,
                     arg3+n*15,
                     arg4+n*15,
...
void op_par_loop_poisson_set_rhs1(char const *name, op_set set,
  ...
  if (OP_diags>2) {
    printf(" kernel routine w/o indirection:  poisson_set_rhs1");
  }
  ...
  if (set_size > 0) {
    ...
    op_cuda_poisson_set_rhs1<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
