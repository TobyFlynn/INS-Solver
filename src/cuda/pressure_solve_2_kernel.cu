...
//user function
__device__ void pressure_solve_2_gpu( const int *edgeType, const int *edgeNum,
...
__global__ void op_cuda_pressure_solve_2(
  ...
  if (set_size > 0) {
    ...
    for ( int round=0; round<2; round++ ){
      ...
      if (end-start>0) {
        ...
        op_cuda_pressure_solve_2<<<nblocks,nthread>>>(
        (double *)arg5.data_d,
        (double *)arg6.data_d,
        (double *)arg7.data_d,
        (double *)arg8.data_d,
