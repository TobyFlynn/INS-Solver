...
//user function
__device__ void viscosity_solve_2_gpu( const int *edgeType, const int *edgeNum,
...
__global__ void op_cuda_viscosity_solve_2(
  ...
  if (tid + start < end) {
    ...
    viscosity_solve_2_gpu(arg0+n*1,
                      arg1+n*1,
                      arg2,
                      arg3,
                      arg4,
  ...
  if (set_size > 0) {
    ...
    for ( int round=0; round<2; round++ ){
      ...
      if (end-start>0) {
        ...
        op_cuda_viscosity_solve_2<<<nblocks,nthread>>>(
        (double *)arg5.data_d,
        (double *)arg6.data_d,
        (double *)arg7.data_d,
        (double *)arg8.data_d,
