...
#define op_par_loop_poisson_mf_mm op_par_loop_poisson_mf_mm_gpu
...
#define op_par_loop_poisson_mf_bc op_par_loop_poisson_mf_bc_gpu
...
#define op_par_loop_poisson_mf2_vis op_par_loop_poisson_mf2_vis_gpu
#define op_par_loop_poisson_mf2_faces_vis op_par_loop_poisson_mf2_faces_vis_gpu
...
#define op_par_loop_poisson_mf_mm op_par_loop_poisson_mf_mm_cpu
...
#define op_par_loop_poisson_mf_bc op_par_loop_poisson_mf_bc_cpu
...
#define op_par_loop_poisson_mf2_vis op_par_loop_poisson_mf2_vis_cpu
#define op_par_loop_poisson_mf2_faces_vis op_par_loop_poisson_mf2_faces_vis_cpu
...
void op_par_loop_poisson_mf_edges(char const *name, op_set set,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf_edges_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
    ...
    op_par_loop_poisson_mf_edges_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
...
void op_par_loop_poisson_mf_bedges_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
...
void op_par_loop_poisson_mf_bedges(char const *name, op_set set,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf_bedges_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
    ...
    op_par_loop_poisson_mf_bedges_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
...
void op_par_loop_poisson_mf_zero_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2);
...
//GPU host stub function
#if OP_HYBRID_GPU
void op_par_loop_poisson_mf_zero(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2){
  ...
  if (OP_hybrid_gpu) {
    ...
    op_par_loop_poisson_mf_zero_cpu(name, set,
      arg0,
      arg1,
      arg2);
...
void op_par_loop_poisson_mf_mm_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3);
...
//GPU host stub function
#if OP_HYBRID_GPU
void op_par_loop_poisson_mf_mm(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3){
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf_mm_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3);
    ...
    op_par_loop_poisson_mf_mm_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3);
...
void op_par_loop_poisson_mf_bc0_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
...
void op_par_loop_poisson_mf_bc0(char const *name, op_set set,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf_bc0_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
    ...
    op_par_loop_poisson_mf_bc0_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
...
void op_par_loop_poisson_mf_bc1_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1);

//GPU host stub function
#if OP_HYBRID_GPU
void op_par_loop_poisson_mf_bc1(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1){

  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf_bc1_gpu(name, set,
      arg0,
      arg1);

    }else{
    op_par_loop_poisson_mf_bc1_cpu(name, set,
      arg0,
      arg1);
...
void op_par_loop_poisson_mf_bc_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
...
void op_par_loop_poisson_mf_bc(char const *name, op_set set,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf_bc_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
    ...
    op_par_loop_poisson_mf_bc_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
...
void op_par_loop_poisson_mf2_apply_bc_vis_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
...
void op_par_loop_poisson_mf2_apply_bc_vis(char const *name, op_set set,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf2_apply_bc_vis_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
    ...
    op_par_loop_poisson_mf2_apply_bc_vis_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
...
void op_par_loop_poisson_mf2_vis_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
...
//GPU host stub function
#if OP_HYBRID_GPU
void op_par_loop_poisson_mf2_vis(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf2_vis_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
    ...
    op_par_loop_poisson_mf2_vis_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
...
void op_par_loop_poisson_mf2_faces_vis_gpu(char const *name, op_set set,
  op_arg arg0,
  op_arg arg1,
  op_arg arg2,
  op_arg arg3,
...
void op_par_loop_poisson_mf2_faces_vis(char const *name, op_set set,
  ...
  if (OP_hybrid_gpu) {
    op_par_loop_poisson_mf2_faces_vis_gpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
    ...
    op_par_loop_poisson_mf2_faces_vis_cpu(name, set,
      arg0,
      arg1,
      arg2,
      arg3,
