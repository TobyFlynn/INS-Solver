...
//user function
__device__ void poisson_mf_mm_gpu( const double *u, const double *factor,
...
__global__ void op_cuda_poisson_mf_mm(
...
void op_par_loop_poisson_mf_mm(char const *name, op_set set,
  ...
  if (OP_diags>2) {
    printf(" kernel routine w/o indirection:  poisson_mf_mm");
  }
  ...
  if (set_size > 0) {
    ...
    op_cuda_poisson_mf_mm<<<nblocks,nthread>>>(
      (double *) arg0.data_d,
      (double *) arg1.data_d,
      (double *) arg2.data_d,
      (double *) arg3.data_d,
