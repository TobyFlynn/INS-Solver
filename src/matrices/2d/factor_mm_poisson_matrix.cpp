...
void FactorMMPoissonMatrix2D::calc_mat() {
  timer->startTimer("FactorMMPoissonMatrix2D - calc_mat");
  calc_glb_ind();
  calc_op1();
  calc_op2();
  calc_opbc();
  ...
  timer->endTimer("FactorMMPoissonMatrix2D - calc_mat");
}

void FactorMMPoissonMatrix2D::calc_mm() {
  timer->startTimer("FactorMMPoissonMatrix2D - calc_mm");
  ...
  timer->endTimer("FactorMMPoissonMatrix2D - calc_mm");
}
