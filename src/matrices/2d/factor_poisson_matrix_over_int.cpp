#include "matrices/2d/factor_poisson_matrix_over_int_2d.h"
...
FactorPoissonMatrixOverInt2D::FactorPoissonMatrixOverInt2D(DGMesh2D *m) : PoissonMatrixOverInt2D(m) {
...
void FactorPoissonMatrixOverInt2D::set_factor(op_dat f) {
  factor = f;
}

void FactorPoissonMatrixOverInt2D::calc_op1() {
  timer->startTimer("FactorPoissonMatrixOverInt2D - calc_op1");
  ...
  timer->endTimer("FactorPoissonMatrixOverInt2D - calc_op1");
}

void FactorPoissonMatrixOverInt2D::calc_op2() {
  timer->startTimer("FactorPoissonMatrixOverInt2D - calc_op2");
  ...
  timer->endTimer("FactorPoissonMatrixOverInt2D - calc_op2");
}

void FactorPoissonMatrixOverInt2D::calc_opbc() {
  timer->startTimer("FactorPoissonMatrixOverInt2D - calc_opbc");
  if(mesh->bface2cells) {
  ...
  timer->endTimer("FactorPoissonMatrixOverInt2D - calc_opbc");
}
