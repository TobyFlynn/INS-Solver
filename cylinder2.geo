...
p5 = newp; Point(p5) = {0.2, 0.2, 0, lc2};
p6 = newp; Point(p6) = {0.25, 0.2, 0, lc2};
p7 = newp; Point(p7) = {0.2, 0.15, 0, lc2};
p8 = newp; Point(p8) = {0.15, 0.2, 0, lc2};
p9 = newp; Point(p9) = {0.2, 0.25, 0, lc2};
